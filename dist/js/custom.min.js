...
// for small screen sidemenu wrap
...
// Side nav hide when click outside START

$(".nav-toggler").click(function(e){
    $(".left-sidebar").show();
    e.stopPropagation();
});
$('.page-wrapper, .navbar-header, .topbartoggler').click(function(){
...
$('.page-wrapper, .navbar-header, .nav-toggler').click(function(){
    $("#navbarSupportedContent").removeClass('show');
    // $(".ti-close").addClass('ti-menu');
});

// Side nav hide when click outside END

// -------------------------------- upload image drag and drop START ----------------------
...
$('.image-upload-wrap').bind('dragover dragenter', function () {
    $('.image-upload-wrap').addClass('image-dropping');
});
$('.image-upload-wrap').bind('dragleave dragend drop', function () {
